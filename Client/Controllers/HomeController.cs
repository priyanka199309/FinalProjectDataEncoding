...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var serverResponse=await AccessTokenRefreshWrapper(()=>SecuredGetRequest("https://localhost:5005/secret/index"));
            var apiResponse = await AccessTokenRefreshWrapper(() => SecuredGetRequest("https://localhost:5009/secret/index"));
        ...
        private async Task RefreshAccessToken()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:5005/oauth/token")
            {
